# Introduction
The purpose of this app is to extract data from the FC2 log files generated by a Potensic Eve application or a Potensic PTD-1 drone controller and to convert them into a CSV file suitable for feeding into the [Telemetry Overlay](https://goprotelemetryextractor.com) application. Which lets me create heads-up displays that can be [overlaid on video generated by a Potensic Atom-2 drone](https://youtu.be/HEvdd6tKyeg). 
