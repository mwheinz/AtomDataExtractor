...
ATOM2_FIELDS = [
    ...
    # (85-295) Unknown.
    FLFD("u85","<Q",85,8, FLFD.hex_dump8),
    FLFD("u93","<Q",93,8, FLFD.hex_dump8),
    FLFD("u101","<Q",101,8, FLFD.hex_dump8),
    FLFD("u109","<Q",109,8, FLFD.hex_dump8),
    FLFD("u117","<Q",117,8, FLFD.hex_dump8),
    FLFD("u125","<Q",125,8, FLFD.hex_dump8),
    FLFD("u133","<Q",133,8, FLFD.hex_dump8),
    FLFD("u141","<Q",141,8, FLFD.hex_dump8),
    FLFD("u149","<Q",149,8, FLFD.hex_dump8),
    FLFD("u157","<Q",157,8, FLFD.hex_dump8),
    FLFD("u165","<Q",165,8, FLFD.hex_dump8),
    FLFD("u173","<Q",173,8, FLFD.hex_dump8),
    FLFD("u181","<Q",181,8, FLFD.hex_dump8),
    FLFD("u189","<Q",189,8, FLFD.hex_dump8),
    FLFD("u197","<Q",197,8, FLFD.hex_dump8),
    FLFD("u205","<Q",205,8, FLFD.hex_dump8),
    FLFD("u213","<Q",213,8, FLFD.hex_dump8),
    FLFD("u221","<Q",221,8, FLFD.hex_dump8),
    FLFD("u229","<Q",229,8, FLFD.hex_dump8),
    FLFD("u237","<Q",237,8, FLFD.hex_dump8),
    FLFD("u245","<Q",245,8, FLFD.hex_dump8),
    FLFD("u253","<Q",253,8, FLFD.hex_dump8),
    FLFD("u261","<Q",261,8, FLFD.hex_dump8),
    FLFD("u269","<Q",269,8, FLFD.hex_dump8),
    FLFD("u277","<Q",277,8, FLFD.hex_dump8),
    FLFD("u285","<Q",285,8, FLFD.hex_dump8),
    FLFD("u293","<I",293,4, FLFD.hex_dump4),
