...
ATOM2_FIELDS = [
    ...
    FLFD("Drone Mode 2", "<B", 428, 1, FLFD.drone_mode),

    # (429) Flag that indicates return-to-home has been activated.
    FLFD("RTH", "<B", 429, 1),

    # Appears to duplicate positioning mode. 1 = ATTI, 2 = OPTI, 3 = GPS.
    FLFD("Positioning Mode 2", "<B", 430, 1),

    # (431) Claude claims this indicates landing detection.
    ...
    # (462-463) Possibly RC signal quality.
